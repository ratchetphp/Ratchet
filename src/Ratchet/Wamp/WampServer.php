 ...
 *
 * @see http://wamp.ws The WAMP specification
 * @see https://github.com/oberstet/autobahn-js Souce for client side library
 * @see http://autobahn.s3.amazonaws.com/js/autobahn.min.js Minified client side library
 */
