...
class RouterTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        ...
        $this->_uri = $this->getMock(\Psr\Http\Message\UriInterface::class);
        $this->_req = $this->getMock(\Psr\Http\Message\RequestInterface::class);
        $this->_req
            ->expects($this->any())
            ->method('getUri')
            ->will($this->returnValue($this->_uri));
        $this->_matcher = $this->getMock(\Symfony\Component\Routing\Matcher\UrlMatcherInterface::class);
        $this->_matcher
            ->expects($this->any())
            ->method('getContext')
            ->will($this->returnValue($this->getMock(\Symfony\Component\Routing\RequestContext::class)));
    ...
    public function testControllerIsMessageComponentInterface(): void {
        $this->setExpectedException('\UnexpectedValueException');
        $this->_matcher->expects($this->any())->method('match')->will($this->returnValue([
    ...
    public function testControllerOnOpen(): void {
        ...
        $expectedConn = new \PHPUnit_Framework_Constraint_IsInstanceOf(\Ratchet\ConnectionInterface::class);
    ...
    public function testRouterGeneratesRouteParameters(): void {
        ...
        $conn = $this->getMock(\Ratchet\Mock\Connection::class);
